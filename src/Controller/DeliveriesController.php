...
class DeliveriesController extends AppController
{
    ...
    {
        $delivery = $this->Deliveries->get($id, contain: ['Orders', 'Staffs']);
    ...
    public function add()
    {
        ...
        $staffs = $this->Deliveries->Staffs->find('list', limit: 200)->all();
        $this->set(compact('delivery', 'orders', 'staffs'));
    }
